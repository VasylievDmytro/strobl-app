...
export function TopHeader({ onOpenSidebar }: { onOpenSidebar: () => void }) {
  ...
  return (
    <header className="surface-card mb-5 overflow-hidden px-4 py-4 md:px-5 2xl:mb-6 2xl:px-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-2.5 text-balance text-[1.9rem] font-semibold leading-tight text-ink-900 md:text-[2rem] 2xl:mt-3 2xl:text-[2.15rem]">
                {title}
              </p>
              <div className="mt-2.5 flex flex-wrap items-center gap-2 2xl:mt-3">
        ...
        <div className="hidden shrink-0 lg:flex lg:flex-col lg:items-end lg:justify-end">
          <div className="rounded-[1.7rem] border border-white/85 bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(247,251,255,0.86))] px-4 py-3 shadow-[0_24px_54px_-30px_rgba(17,49,87,0.38)] backdrop-blur-xl 2xl:rounded-[2rem] 2xl:px-5 2xl:py-4">
